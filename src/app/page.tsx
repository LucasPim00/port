...
export default function Home() {
  ...
  return (
    <div className="flex h-screen overflow-hidden relative bg-gradient-to-r from-[#181685] via-[#077c85] to-black text-white" style={{ perspective: '1500px' }}>
      ...
      <div className="fixed top-4 right-4 z-50 cursor-pointer group">
        <div className="flex items-center gap-1 p-1 bg-white/10 rounded-full border border-cyan-400 transition-transform group-active:scale-90 animate-click">
          <img
            src="/brasil.jpeg"
            alt="Português"
      ...
      <div
  className={`scroll-bar transition-all duration-500 ${
